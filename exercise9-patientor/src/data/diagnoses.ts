...
const diagnoses: Array<Diagnosis> = [
    ...
    },
    {
        "code": "503.5",
        "name":
            `Sprain and strain of joints and ligaments
            of other and unspecified parts of head`,
        "latin":
            `Distorsio et/sive distension articulationum
            et/sive ligamentorum partium aliarum sive`
    },
    {
        "code": "J10.1",
        "name":
            `Influenza with other respiratory manifestations,
            other influenza virus codeentified`,
        "latin":
            `Influenza cum aliis manifestationibus respiratoriis ab agente
            virali codeentificato`
    },
    {
        "code": "J06.9",
